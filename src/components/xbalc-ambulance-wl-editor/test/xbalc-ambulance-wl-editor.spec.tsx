...
import { XbalcAmbulanceWlEditor } from '../xbalc-ambulance-wl-editor';
import axios from 'axios';
import MockAdapter from 'axios-mock-adapter';
import { Condition, WaitingListEntry } from '../../../api/ambulance-wl';

describe('xbalck-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [XbalcAmbulanceWlEditor],
      html: `<xbalc-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
      components: [XbalcAmbulanceWlEditor],
      html: `<xbalc-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></xbalc-ambulance-wl-editor>`,
    });
