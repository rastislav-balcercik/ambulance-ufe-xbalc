...
describe('xbalc-ambulance-wl-list', () => {
  ...
  it('renders sample entries', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<xbalc-ambulance-wl-list ambulance-id="test-ambulance" api-base="http://test/api"></xbalc-ambulance-wl-list>`,
    });
  ...
  it('renders error message on network issues', async () => {
    ...
    const page = await newSpecPage({
      components: [XbalcAmbulanceWlList], //
      html: `<xbalc-ambulance-wl-list ambulance-id="test-ambulance" api-base="http://test/api"></xbal-ambulance-wl-list>`, //
    });
